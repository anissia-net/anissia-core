...
class TestDataController(
    ...
    fun basic(): String {
        ...
        accountRepository.save(Account(
            ...
            name = "어드민",
            roles = mutableSetOf(AccountRole.ROOT, AccountRole.TRANSLATOR)
        ))
        ...
        boardTopicRepository.save(BoardTopic(ticker = "notice", topic = "공지사항", an = 1))
        boardTopicRepository.save(BoardTopic(ticker = "inquiry", topic = "문의입니다.", an = 2))
