...
interface LoginService {
    fun doUserLogin(cmd: DoUserLoginCommand, sessionItem: SessionItem): ApiResponse<JwtAuthInfoItem>
    fun doTokenLogin(cmd: DoTokenLoginCommand, sessionItem: SessionItem): ApiResponse<JwtAuthInfoItem>
}
