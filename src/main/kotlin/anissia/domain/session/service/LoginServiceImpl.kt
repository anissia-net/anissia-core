...
class LoginServiceImpl(
    ...
    override fun doUserLogin(cmd: DoUserLoginCommand, sessionItem: SessionItem): ApiResponse<JwtAuthInfoItem> {
        cmd.validate()
        ...
        if (account == null) {
            ...
            throw ApiFailException("암호가 일치하지 않거나 존재하지 않는 계정입니다.")
        }
    ...
    override fun doTokenLogin(cmd: DoTokenLoginCommand, sessionItem: SessionItem): ApiResponse<JwtAuthInfoItem> {
        val ip = sessionItem.ip
