...
interface RecoverPasswordService {
    fun request(cmd: RequestRecoverPasswordCommand, sessionItem: SessionItem): ApiResponse<Unit>
    fun validate(cmd: ValidateRecoverPasswordCommand): ApiResponse<Unit>
    fun complete(cmd: CompleteRecoverPasswordCommand): ApiResponse<Unit>
}
