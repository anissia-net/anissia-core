...
interface AnimeHitHourRepository : ReactiveCrudRepository<AnimeHitHour, AnimeHitHour.Key> {
    ...
    """)
    fun extractAllAnimeRank(startHour: Long, pageable: Pageable = PageRequest.of(0,100)): Flux<AnimeRankItem>
    ...
    """, nativeQuery = true)
    fun mergeByDay(beforeDays: Int): Mono<Int>
    ...
    fun deleteMergedByDay(beforeDays: Int): Mono<Int>
    ...
    @Query("""
        ...
        group by ym, anime_no on duplicate key update hit = hit + values(hit)
    """, nativeQuery = true)
    fun mergeByMonth(beforeDays: Int): Mono<Int>
    ...
    fun deleteMergedByMonth(beforeDays: Int): Mono<Int>
}
