...
class AnimeScheduleController(
    ...
    fun getSchedule(cmd: GetScheduleCommand, exchange: ServerWebExchange): ApiResponse<List<AnimeScheduleItem>> =
        ApiResponse.ok(animeScheduleService.get(cmd, exchange))
