...
//            .flatMap { mergeAnimeHit() }
//            // step 3. extract and bind rank
//            .flatMap { extractAllRank() }
...
//                .doOnNext { animeHit ->
//                    animeHitHourRepository.findById(animeHit.key)
//                        .map { it.hit += animeHit.hit; it }
//                        .switchIfEmpty(Mono.just(animeHit))
//                        .flatMap { animeHitHourRepository.saveAll(it) }
//
//                }
//                .collectList()
//                .also {  }
...
//    private fun extractAllRank(): Mono<String> {
